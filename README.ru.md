...
<p align="center">
  <a href="https://github.com/solankisumit123/omniGet/releases/latest"><img src="https://img.shields.io/github/v/release/solankisumit123/omniGet?style=for-the-badge&label=release" alt="Последний релиз" /></a>
  ...
  <a href="https://github.com/solankisumit123/omniGet/releases"><img src="https://img.shields.io/github/downloads/solankisumit123/omniGet/total?style=for-the-badge&label=downloads" alt="Всего загрузок" /></a>
...
<table>
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/solankisumit123/omniGet/releases/latest"><img alt="Скачать OmniGet для Windows" src="https://img.shields.io/badge/Windows-Portable_EXE-0078D6?style=for-the-badge&logo=windows&logoColor=white" height="38"></a>
      <br/>
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/solankisumit123/omniGet/releases/latest"><img alt="Скачать OmniGet для macOS" src="https://img.shields.io/badge/macOS-DMG-000000?style=for-the-badge&logo=apple&logoColor=white" height="38"></a>
      <br/>
  ...
  <tr>
    ...
    <td>
      <a href="https://github.com/solankisumit123/omniGet/releases/latest"><img alt="Скачать OmniGet для Linux в формате deb, rpm или AppImage" src="https://img.shields.io/badge/Linux-deb_·_rpm_·_AppImage-FFAA33?style=for-the-badge&logo=linux&logoColor=white" height="38"></a>
      <br/>
...
В репозитории также есть `omniget-cli` — небольшая программа на Rust, которая делает OmniGet пригодным для скриптов. Она входит в каждый релиз: скачайте `omniget-cli-<версия>-<платформа>` из [последнего релиза](https://github.com/solankisumit123/omniGet/releases/latest) для Windows, macOS (Intel и Apple Silicon) или Linux. Чтобы собрать её из этого репозитория:
...
Нашли баг или есть идея? [Откройте issue](https://github.com/solankisumit123/omniGet/issues). Pull request приветствуются, см. [CONTRIBUTING.md](CONTRIBUTING.md).
...
[![Участники](https://contrib.rocks/image?repo=solankisumit123/omniGet)](https://github.com/solankisumit123/omniGet/graphs/contributors)
