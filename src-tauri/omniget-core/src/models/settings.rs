...
pub struct AdvancedSettings {
    ...
    /// OmniTurbo Video Accelerator: multi-lane chunking, anti-throttle bypass & speculative racing.
    #[serde(default = "default_turbo_mode")]
    pub turbo_mode: bool,
    #[serde(default = "default_turbo_concurrency")]
    pub turbo_concurrency: u32,
    #[serde(default = "default_anti_throttle")]
    pub anti_throttle: bool,
    #[serde(default = "default_speculative_hedging")]
    pub speculative_hedging: bool,
    #[serde(default = "default_chunk_burst_size_mb")]
    pub chunk_burst_size_mb: u32,
    #[serde(default = "default_tcp_buffer_size_mb")]
    pub tcp_buffer_size_mb: u32,
}

fn default_turbo_mode() -> bool {
    true
}

fn default_turbo_concurrency() -> u32 {
    16
}

fn default_anti_throttle() -> bool {
    true
}

fn default_speculative_hedging() -> bool {
    true
}

fn default_chunk_burst_size_mb() -> u32 {
    10
}

fn default_tcp_buffer_size_mb() -> u32 {
    32
}
    ...
    fn default() -> Self {
        Self {
            ...
            advanced: AdvancedSettings {
                ...
                anti_throttle: true,
                speculative_hedging: true,
                chunk_burst_size_mb: 10,
                tcp_buffer_size_mb: 32,
            },
