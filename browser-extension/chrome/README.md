...
Install OmniGet from [github.com/solankisumit123/omniGet/releases](https://github.com/solankisumit123/omniGet/releases/latest) and **launch it once**. On first launch it generates a per-installation pairing token and starts the local bridge on `127.0.0.1:47720` (or the next free port up to `47729`).
