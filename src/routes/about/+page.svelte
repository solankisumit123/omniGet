<script lang="ts">
    ...
    async function openAuthorGithub(e: Event) {
        e.preventDefault();
        await open("https://github.com/solankisumit123");
    }
</script>
...
<div class="about-overview">
    ...
    <div class="about-external">
        <a href="https://github.com/solankisumit123/omniGet" target="_blank" rel="noopener" class="btn about-ext-link">
    ...
    <footer class="about-footer">
        ...
        <a href="https://github.com/solankisumit123" class="about-watermark" onclick={openAuthorGithub} title="@solankisumit123">
            @solankisumit123
        </a>
    </footer>
</div>
