<script lang="ts">
  ...
  const GITHUB_URL = "https://github.com/solankisumit123/omniGet";
...
<section class="star-section">
  ...
  <div class="star-iframe-wrapper">
    <iframe
      src="https://ghbtns.com/github-btn.html?user=solankisumit123&repo=omniGet&type=star&count=true&size=large"
      frameborder="0"
      scrolling="0"
      width="170"
      height="30"
